...
public class Peak_Element {
    //leet-code problem 852. peakIndexInMountainArray(easy) and  162.peakElementIndex array(medium) both are same with same solution

  public static void main(String[] args) {
    int[] array={2,3,4,5,7,6,5,1};
    int ans = peakElementIndexArray (array );
    System.out.println (ans);
}
    static int peakElementIndexArray(int[] array){
        int start=0;
